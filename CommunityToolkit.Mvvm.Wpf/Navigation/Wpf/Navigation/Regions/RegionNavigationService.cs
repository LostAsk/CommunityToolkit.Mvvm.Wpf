...
namespace CommunityToolkit.Mvvm.Navigation.Regions
{
    ...
    public class RegionNavigationService : IRegionNavigationService
    {
        ...
        public RegionNavigationService(IServiceProvider serviceProvider,IRegionNavigationContentLoader regionNavigationContentLoader, IRegionNavigationJournal journal)
        {
        ...
        private void ExecuteNavigation(NavigationContext navigationContext, object[] activeViews, Action<NavigationResult> navigationCallback)
        {
            try
            {
                ...
                IRegionNavigationJournalEntry journalEntry = ServiceProvider.GetService<IRegionNavigationJournalEntry>();
