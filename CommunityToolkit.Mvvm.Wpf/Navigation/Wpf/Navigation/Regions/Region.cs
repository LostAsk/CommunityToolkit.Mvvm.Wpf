    ...
    public class Region : IRegion
    {
        ...
        public IRegionNavigationService NavigationService
        {
            get
            {
                ...
                {
                    _regionNavigationService =Ioc.Default.GetRequiredService<IRegionNavigationService>();
        ...
        {
            var view = Ioc.Default.GetKeyedService<object?>(viewName);
        ...
        private void InnerAdd(object view, string viewName, IRegionManager scopedRegionManager)
        {
            ...
            //如果view 为依赖对象。则设置view属于这个IRegionManager管理对象
