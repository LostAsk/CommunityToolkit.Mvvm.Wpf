...
namespace CommunityToolkit.Mvvm.Navigation.Regions
{
    ...
    public class RegionNavigationContentLoader : IRegionNavigationContentLoader
    {
        ...
        public RegionNavigationContentLoader(IServiceProvider serviceProvider)
        {
        ...
        protected virtual object CreateNewRegionItem(string candidateTargetContract)
        {
            try
            {
                var newRegionItem = _serviceProvider.GetKeyedService<object>(candidateTargetContract);
        ...
        protected virtual IEnumerable<object> GetCandidatesFromRegion(IRegion region, string candidateNavigationContract)
        {
            ...
            if (!contractCandidates.Any())
            {
                ...
                var matchingType = _serviceProvider.IsRegistrationType(candidateNavigationContract);
