...
namespace CommunityToolkit.Mvvm.Navigation.Regions.Behaviors
{
    ...
    public class SyncRegionContextWithHostBehavior : RegionBehavior, IHostAwareRegionBehavior
    {
        ...
        private ObservableCtsAccessor<object> HostControlRegionContext
        {
            get
            {
        ...
        protected override void OnAttach()
        {
            if (this.HostControl != null)
            {
                ...
                this.HostControlRegionContext.PropertyChanged += this.RegionContextObservableCtsAccessor_PropertyChanged;
        ...
        void RegionContextObservableCtsAccessor_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
