...
namespace CommunityToolkit.Mvvm.Dialogs
{
    /// <summary>
    ...
    public class DialogService : IDialogService
    {
        ...
        protected virtual IDialogWindow CreateDialogWindow(string name)
        {
            if (string.IsNullOrWhiteSpace(name))
                return _containerExtension.GetService<IDialogWindow>();
            else
                return _containerExtension.GetKeyedService<IDialogWindow>(name);
        }
        ...
        {
            var content = _containerExtension.GetKeyedService<object>(dialogName);
